...
export default function Home() {
  return (
    <section className="flex justify-center items-start min-h-dvh md:py-24">
      <div className="container max-w-4xl bg-white md:rounded-4xl ">
        ...
        <div className="p-8 flex flex-col gap-8">
          ...
          <div className="bg-rose-50 p-8 rounded-3xl">
            ...
            <ul className="mt-4 list-disc list-inside marker:text-pink-800 marker:text-base flex flex-col gap-2">
              <li>
                <strong className="pl-4">Total:</strong> Approximately 10
                minutes
              </li>
              <li>
          ...
          <div>
            ...
            <ol className="mt-4 ml-8 list-decimal flex flex-col gap-2 marker:font-bold marker:text-brown-800">
              ...
              <li className="pl-4">
                <strong className="text-stone-600!">Heat the pan:</strong> Place
